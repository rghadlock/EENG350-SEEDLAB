/* TurnThenDrive.ino
 * 
 * Purpose : This file implement both control system for the project demonstration where
 * the system must rotate and then drive. The robot start after 1.5 seconds, rotates for
 * 15 seconds, and then drives for 7.5 seconds.
 * 
 */
